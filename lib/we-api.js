...
var WeAPI = function(apiKey) {
	...
	this.getProfileByEmail = function(params, callback) {
		...
		var request_options = {
			url: this.weApiRoot + 'profile/find_one/by_email/basic', 
			headers: {
	...
	this.getProfileByAddress = function(params, callback) {
		...
		//Build the request options object
		var request_options = {
			url: this.weApiRoot + 'profile/find_one/by_address/basic', 
			headers: {
				"Content-Type": "application/json", 
				"Authorization": "APIKey " + this.apiKey
			}, 
	...
	this.getProfileByPhone = function(params, callback) {
		...
		//Build the request options object
		var request_options = {
			url: this.weApiRoot + 'profile/find_one/by_phone/basic', 
			headers: {
				"Content-Type": "application/json", 
				"Authorization": "APIKey " + this.apiKey
			}, 
